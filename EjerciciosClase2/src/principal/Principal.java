...
public class Principal {
	...
	//	practicas.listaEstudiantes(practicas.introListas());
		...
		//practicas.leerFichero("personas");
		//HashMap<String, ArrayList<Float>> mapa2 = practicas.resumenVentasVendedor("ventasDeptoAlmacen");
	
		
		ArrayList<Float> movimientos = new ArrayList<Float>();
		float saldoInicial = 1500.0f;
		movimientos.add(235.2f);
		movimientos.add(23.6f);
		practicas.calculaSaldo(saldoInicial, movimientos);
		
		//practicas.resumenVentaVendedor();
